...
for i in range(0, count):
    try:
        ...
        posflux1,mag1 = sourcephotometry(228, 43, posflux)  #比较星位置1        
        posflux2,mag2 = sourcephotometry(203, 315, posflux)  #比较星位置2
        
        posflux3,mag3 = sourcephotometry(252, 36, posflux)   
