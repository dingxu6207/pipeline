...
sigma = round(sigma, 4)
plt.plot(dataincl[0,:], dataincl[0,:]-dataincl[1,:]+48, '.')
...
sigma = round(sigma, 4)
plt.plot(datadivt[0,:]/100, datadivt[1,:]/100, '.')
plt.plot(datadivt[0,:]/100, datadivt[0,:]/100, '-', c='r')
plt.plot(datadivt[0,:]/100, (datadivt[0,:]-datadivt[1,:])/100+0.76, '.')
...
sigma = round(sigma, 4)
plt.plot(dataq[0,:]/100, dataq[1,:]/100, '.')
plt.plot(dataq[0,:]/100, dataq[0,:]/100, '-', C='r')
plt.plot(dataq[0,:]/100, (dataq[0,:]-dataq[1,:])/100, '.')
...
sigma = round(sigma, 4)
plt.plot(datar[0,:]/100, datar[1,:]/100, '.')
plt.plot(datar[0,:]/100, datar[0,:]/100, '-', c='r')
plt.plot(datar[0,:]/100, (datar[0,:]-datar[1,:])/100+0.35, '.')
