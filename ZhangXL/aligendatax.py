# -*- coding: utf-8 -*-
"""
Created on Tue Dec 21 11:30:02 2021
...
filetemp = []
count = 0
oripath = 'E:\\shunbianyuan\\phometry\\pipelinecode\\pipeline\\ZhangXL\\xiong\\'  #路径参数
...
imageio.mimsave(wrpath+'test.gif', gif_images, fps=10)